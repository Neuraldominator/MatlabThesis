...
% folders called "ANdata0", "ANdata1" and "ANdata2".
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
plot(VSCI_AN40(:,2), VSCI_AN40(:,1), 'b+')
hold on
plot(VSCI_AN70(:,2), VSCI_AN70(:,1), 'ro')
plot(VSCI_GBC40(:,2), VSCI_GBC40(:,1), 'g*')
plot(VSCI_GBC70(:,2), VSCI_GBC70(:,1), 'ks')
hold off
...
xlim([0,10])
ylim([0,1])
legend("AN, 40db","AN, 70db","GBC, 40db","GBC, 70db", 'Location', 'best')
